                                ...
                                <div class="relative flex flex-col w-full h-full">
                                    ...
                                    <div class="relative border-box w-full flex flex-col gap-4 px-5 pb-8 gap-4" x-show="currentPage === 1">
                                            ...
                                            <flux:field>
                                                <div class="flex flex-col gap-2">
                                                    <flux:label class="flex gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-blue-500" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M12 19V4.5h-.5L9.5 6"/></svg>
                                            ...
                                            <flux:field>
                                                <div class="flex flex-col gap-2">
                                                    <flux:label class="flex gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="text-blue-500" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M16 19H8v-2.024a1 1 0 0 1 .37-.776l6.128-4.98A4.07 4.07 0 0 0 16 8.065V8a4 4 0 0 0-8 0"/></svg>
                                            ...
                                            <flux:field>
                                                <div class="flex flex-col gap-2">
                                                    <flux:label class="flex gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="text-blue-500" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M8.5 5h7v1.5l-5 3.5v1H12a4 4 0 0 1 0 8h-.5a4 4 0 0 1-4-4"/></svg>
                                                        <span>Last Name</span>
                                                    </flux:label>
                                            ...
                                            <flux:field>
                                                <div class="flex flex-col gap-2">
                                                    <flux:label class="flex gap-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="text-blue-500" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="square" stroke-width="2" d="M14.5 19v-4m0 0H7v-1l6.5-9h1zm0 0h2"/></svg>
                                                        <span>Suffix</span>
                                                    </flux:label>
