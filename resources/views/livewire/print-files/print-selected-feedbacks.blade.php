<div class="max-w-5xl mx-auto bg-white p-10 rounded-lg shadow space-y-12">
    ...
    <div class="text-center border-b pb-6">
        <h1 class="text-3xl font-bold text-gray-800">Selected Feedback Reports</h1>
    ...
    @forelse ($feedbacks as $feedback)
        ...
        @endif
    @empty
        <p class="text-center text-gray-600 italic">No selected feedbacks available for printing.</p>
    @endforelse
</div>
