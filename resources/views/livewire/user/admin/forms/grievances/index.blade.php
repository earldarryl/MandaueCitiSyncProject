            ...
            >
                ...
                >
                    ...
                    <div class="flex flex-col items-center justify-center w-full">
                        ...
                        <div wire:loading.remove wire:target="resetInputFieldsByCancelModal" class="flex flex-col w-full">
        ...
        >
            ...
            >
                ...
                <div class="flex flex-col gap-2 items-center justify-center w-full">
                    ...
                    >
                        <p class="text-sm text-gray-600 dark:text-gray-300 mb-4">
                            Reroute the selected reports to a different department with the appropriate type and category.
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-zinc-700">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th wire:click="sortBy('grievance_ticket_id')" scope="col" class="px-6 py-3 cursor-pointer">
                                ...
                                <th wire:click="sortBy('users.name')" scope="col" class="px-6 py-3 cursor-pointer">
                                    <div class="flex items-center justify-between">
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-zinc-700">
                            @forelse($grievances as $grievance)
                                <tr wire:key="grievance-{{ $grievance->grievance_ticket_id }}" class="hover:bg-gray-50 dark:hover:bg-zinc-800 transition">
                                    ...
                                    <td class="px-6 py-4 text-sm font-semibold text-gray-800 dark:text-gray-100">
                                        {{ Str::limit($grievance->grievance_title, 60) }}
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-center space-x-1">
                                        <a href="{{ route('admin.forms.grievances.view', $grievance) }}" wire:navigate
