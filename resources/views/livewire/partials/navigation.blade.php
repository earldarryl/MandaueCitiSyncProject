...
<nav x-data="{ open: false }" class="w-full">
    ...
    <div x-show="$store.notifications.open" x-cloak class="fixed inset-0 z-40 flex">
        ...
        <div
            ...
            class="relative w-96 bg-white dark:bg-zinc-800 shadow-xl h-screen ml-auto flex flex-col"
        >
            <!-- Header -->
            <div class="flex items-center justify-between p-4 border-b dark:border-zinc-700 flex-shrink-0">
                <span class="font-semibold">Notifications</span>
                <button @click="$store.notifications.close()" class="p-2 hover:bg-gray-200 dark:hover:bg-zinc-700 rounded">✕</button>
            </div>
