        ...
        <form wire:submit="updateProfileInformation" class="mt-6 space-y-6">
            ...
            >
                ...
                <flux:input.group>
                    ...
                    clearable
                    x-bind:class="{
                        'border border-green-500 ring-2 ring-green-300 bg-green-200': status === 'success',
                        'border border-red-500 ring-2 ring-red-300 bg-red-200': {{ json_encode($errors->has('name')) }},
                        '': status === '' && {{ json_encode(!$errors->has('name')) }}
                    }"
                />
                </flux:input.group>
            ...
            <flux:field
                ...
                class="flex flex-col gap-3"
            >
                <flux:label for="name">{{ __('Email') }}</flux:label>
                ...
                <flux:input.group>
                    ...
                    x-bind:class="{
                        'border border-green-500 ring-2 ring-green-300 bg-green-200': status === 'success',
                        'border border-red-500 ring-2 ring-red-300 bg-red-200': {{ json_encode($errors->has('email')) }},
                        '': status === '' && {{ json_encode(!$errors->has('email')) }}
                    }"
                />
                </flux:input.group>
                ...
                @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! auth()->user()->hasVerifiedEmail())
                    <flux:modal wire:model.self="showMyModal" name="my-unique-modal-name" class="w-96">
                        <div class="space-y-6">
                            ...
                            <flux:text class="mt-2">Your email is unverified, please verify your email.</flux:text>
                            </div>
                            <div class="flex">
                                <flux:spacer />
                                <flux:button type="button" variant="primary" wire:click="redirectEmailVerify">Proceed</flux:button>
                            </div>
                        </div>
                    </flux:modal>
                @endif
