            ...
            <div class="flex flex-col gap-2 w-full">
                <div class="flex items-center justify-between w-full">
                    <div class="flex items-center gap-3">
                        <h2 class="flex items-center gap-2 text-lg font-bold text-gray-700 dark:text-gray-100">
                            ...
                            <span>Grievances by Priority Level (Admin)</span>
                        </h2>
                    </div>
                </div>
                ...
                <div x-data="{ open: false }" class="mt-1">
                    ...
                    <div x-show="open" x-collapse
                        ...
                        This chart shows the total number of grievances in the system,
                        ...
                        Helps Admins identify the urgency of all grievances and prioritize actions accordingly.
                    </div>
                </div>
            </div>
        HTML);
