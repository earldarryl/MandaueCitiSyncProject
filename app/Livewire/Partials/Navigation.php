...
class Navigation extends Component
{
    ...
    private $routeHeaders = [
        ...
        'admin.stakeholders.departments-and-hr-liaisons.hr-liaisons-list-view' =>'HR Liaisons List View',
        'admin.stakeholders.departments-and-hr-liaisons.hr-liaisons-list-assignments' => "HR Liaison's Assignment",
        'admin.reports-and-analytics.index' => 'Reports & Analytics',
        'admin.forms.grievances.index' => 'Reports',
        'admin.forms.grievances.view'=> 'View Report',
        ...
        'citizen.grievance.index'    => 'My Reports',
        'citizen.grievance.create'   => 'File a Report',
        'citizen.grievance.edit'     => 'Edit Report',
        'citizen.grievance.view'     => 'View Report',
    ...
    public function getHeaderIconClass()
    {
        $icons = [
            ...
            "HR Liaison's Assignment" => 'bi bi-person-rolodex',
            'HR Liaisons List View' => 'bi bi-person-lines-fill',
            'Departments & HR Liaisons' => 'bi bi-person-badge',
            'Reports' => 'bi bi-file-earmark-text',
            'View Report' => 'bi bi-eye',
            ...
            'My Reports' => 'bi bi-file-earmark-text',
            'File a Report' => 'bi bi-file-earmark-plus',
