...
class GrievancePriorityLevelsChart extends ChartWidget
{
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <div x-data="{ open: false }" class="mt-1">
                    ...
                    <div x-show="open" x-collapse
                        ...
                        This chart shows the total number of reports assigned to you as an HR Liaison,
                        categorized by <span class="font-semibold text-gray-800 dark:text-gray-200">Priority Levels</span>
                        such as Low, Normal, Medium, High, and Critical.
                        <br><br>
                        <span class="text-gray-800 dark:text-gray-300 font-medium">Purpose:</span>
                        Helps HR Liaisons identify the urgency of assigned reports and prioritize responses
                        accordingly.
                    </div>
                </div>
            </div>
